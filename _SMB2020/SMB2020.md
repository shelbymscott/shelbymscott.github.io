...
author_profile: true
---
A copy of my poster is available [here](https://shelbymscott.github.io/files/Scott_Shelby_OTHE.pdf). Note that the abstract from the program does not correspond directly with the poster. The analyses from this project are not able to be shared publicly at this time, but stay tuned for more of this work!

Because of time zone considerations, I want all participants to hear about my work. I have recorded my poster presentation and it is available [here](https://shelbymscott.github.io/files/Scott_SMB2020_PosterPresentation.m4a). I am happy to answer questions over Slack, email, or feel free to find me in Sococo! For accessibility, an audio description of my poster is available [here](https://shelbymscott.github.io/files/SMB_AudioDescriptionofPoster.m4a).
